...
def get_dataloaders(config):
    ...
    train_dataset = TompeiDataset(train_set, transform=train_transforms, config=config)
    val_dataset = TompeiDataset(val_set, transform=val_test_transforms, config=config)
    test_dataset = TompeiDataset(test_set, transform=val_test_transforms, config=config)
